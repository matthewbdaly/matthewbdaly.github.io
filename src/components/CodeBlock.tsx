...
const CodeBlock = ({children, className, live, metastring, title}) => {
  ...
  if (live) {
    return (
      ...
      >
        ...
        {title && <span className="block w-full p-2 px-8 m-0 mt-2 -mb-8 font-mono text-sm bg-gray-300 border-gray-800 rounded-t-lg shadow-lg text-gray-800">{title}</span>}
  ...
  return (
    <Fragment>
      {title && <span className="block w-full p-2 px-8 m-0 -mb-4 font-mono text-sm bg-gray-300 border-gray-800 rounded-t-lg shadow-lg text-gray-800">{title}</span>}
