  ...
  return (
    <Layout title={siteTitle}>
      ...
      modern PHP and Javascript development, and anything else I find interesting.</p>
        <p className="text-xl py-2">You can find me on <s>Twitter,</s> <Anchor href={data.site.siteMetadata.social.mastodon} rel="me">Mastodon</Anchor> and <Anchor href={`https://github.com/${data.site.siteMetadata.social.github}`} rel="me">GitHub</Anchor></p>
