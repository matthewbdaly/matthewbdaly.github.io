module.exports = {
  siteMetadata: {
    ...
    author: {
      name: "Matthew Daly",
      summary: "who lives in Norfolk and works in Norwich (except during the lockdown and half the week, when he's been working from home).",
    },
    description: "I'm a web developer in Norfolk. This is my blog...",
    siteUrl: "https://matthewdaly.co.uk/",
    social: {
      bluesky: "https://bsky.app/profile/matthewdaly.co.uk",
      github: "matthewbdaly",
